...
export default function AppointmentHistory() {
    ...
    const display = history.length <= 0 ?
        ...
        history.map(({meetingTime, meetingDate, sex, firstName, lastName, appointmentType}) => (
            <div style={{border: '1px solid green', marginTop: '1em', padding: '0.6em', borderRadius: '10px'}}>
